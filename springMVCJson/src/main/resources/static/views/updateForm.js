...
function sendUpdateInfo(){
  ...
  let arrivalUpdate=document.getElementById("datepickerUpdate").value;
  ...
  updatedProduct.arrival=arrivalUpdate;
...
function displayDetailsInForm(){
  ...
  var arrivalUpdate=document.getElementById("datepickerUpdate");
  ...
  arrivalUpdate.value=new Date(oldProduct.arrival);
...
function deleteProductDetail(event){
  event.preventDefault();
  var idProd=event.path[2].id;
  if(idProd==""){
    var urlString=window.location.href;
