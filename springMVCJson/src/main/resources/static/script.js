...
function displayNewArrival(){
  ...
  var url="http://localhost:8090/products/sortbydate";
  var productEl="";
  getDatafromAPI(url)
...
var template=
    '<div class="col-md-3 col-sm-6 portfolio-item d-inline-block" id="arrivalId">'  +
      ' <a class="portfolio-link"  id="modalElement" href="pages/productDetail.html?id='+content.id+'">'+
      ' <div class="portfolio-hover">' +
        '</div>' +
        '<img id="imageId" class="img-fluid"  src='+convertImage(content.image)+' alt="">'  +
      '</a>'  +
...
console.log(content);
  ...
  '<div class="modal-body">'+
    ...
    '<img class=" img-fluid d-block mx-auto"   height= "400px" src="'+convertImage(content.image)+'" alt="">' +
